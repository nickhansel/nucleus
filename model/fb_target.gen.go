...
type FbTarget struct {
	...
	CustomAudiences pq.StringArray `gorm:"type:varchar(255)[]" json:"custom_audiences"`
	FbAdsetID       int64  `gorm:"column:fb_adsetId;not null" json:"fb_adsetId"`
	GeoLocationsID  int64  `gorm:"column:geo_locationsId;not null" json:"geo_locationsId"`
}
